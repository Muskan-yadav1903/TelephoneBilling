...
{	int password;
	...
	printf("\n\t\t ********************************************************");
	printf("\n\n\t\t       Developed By:-Priya,  Roll number :- 0006899176    ");
	printf("\n\n\t\t         DAV College for Girls Yamunanagar - 135001    ");
	...
	while (1)
	{
		...
		switch(choice)
		{
			...
			case 'E':
				system("cls");
				printf("\n\n\t\t\t\tTHANK YOU");
				printf("\n\n\n\n\tFOR USING OUR TELECOM BILLING SERVICE");
				Sleep(2000);
				exit(0);
				break;
			default:
...
***** IF YOU FIND ANY ERRORS OR ANY PROBLEMS RELATED THIS PROGRAM *****
	       ...
	       ***** EMAIL: idealcoachings.ynr@gmail.com *****

		***** CALL: 7876-560006,7876-960006 *****/
